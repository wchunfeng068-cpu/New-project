import { LANGS, DEFAULT_LANG, LANGUAGE_STORAGE_KEY, NAV_LABELS, isValidLang, getDefaultLang, readLanguage, persistLanguage, getProjectRootUrl, withLanguage, addLanguageToAnchor, getCurrentPageKey } from './i18n.js';
...
export const initSharedShell = (options = {}) => {
